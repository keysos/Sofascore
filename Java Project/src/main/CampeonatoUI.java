...
public class CampeonatoUI extends javax.swing.JFrame {
    ...
    private void atualizarTabela(Campeonato campeonato) {
        ...
        tableTeams.getColumnModel().getColumn(0).setCellRenderer(new javax.swing.table.DefaultTableCellRenderer() {
            @Override
            public java.awt.Component getTableCellRendererComponent(JTable table, Object value,
                ...
                int pos = (int) table.getValueAt(row, 0); // pega a posição do time

                if (pos >= 1 && pos <= 4) {
                    setBackground(java.awt.Color.BLUE);
                    setForeground(java.awt.Color.WHITE);
                } else if (pos >= totalRows - 3) {
        ...
        // Renderer para colorir linhas conforme a posição
    }
